...
def create_type_artifacts(workstream_path: Path, workstream_type: str) -> None:
    ...
    if workstream_type == "literature":
        ...
        (artifacts / "search_plan.json").write_text(
            json.dumps({
                "schema_version": 1,
                "generated_at": None,
                "generated_by": None,
                ...
                "source_contexts": [],
                "extracted_bib_keys": [],
                "extracted_technical_phrases": [],
                "query_families": [],
                "suggested_literature_search_command": "",
            }, indent=2) + "\n",
            encoding="utf-8",
        )
        ...
        (artifacts / "citation_graph.json").write_text(
            json.dumps({
                "schema_version": 1,
                "generated_at": None,
                "generated_by": None,
                "input_results": "artifacts/literature_search_results.json",
                "seeds": [],
                "seed_payloads": [],
                "expanded_results": [],
                "merged_related_results": [],
                "recommended_followup_queries": [],
                "errors": [],
            }, indent=2) + "\n",
            encoding="utf-8",
        )
        (artifacts / "citation_graph.md").write_text(
        ...
        (artifacts / "search_coverage_validation.json").write_text(
            json.dumps({
                "schema_version": 1,
                "generated_at": None,
                "generated_by": None,
                "passed": False,
                "errors": ["Search coverage has not been validated yet."],
                "warnings": [],
                "metrics": {},
            }, indent=2) + "\n",
            encoding="utf-8",
        ...
        (artifacts / "theorem_applicability_matrix.json").write_text(
            json.dumps({
                "schema_version": 1,
                "generated_at": None,
                "generated_by": None,
                "no_exact_theorem_statements": False,
                "no_exact_theorem_statements_reason": "",
                "entries": [],
            }, indent=2) + "\n",
            encoding="utf-8",
        )
        (artifacts / "theorem_applicability_validation.json").write_text(
            json.dumps({
                "schema_version": 1,
                "generated_at": None,
                "generated_by": None,
                "passed": False,
                "errors": ["Theorem applicability has not been validated yet."],
                "warnings": [],
                "metrics": {},
            }, indent=2) + "\n",
            encoding="utf-8",
